...
import {hasUseTypes} from '../../semantics/util.js';
...
export class TypedModeTransformer extends ParseTreeTransformer {
  transformScript(tree) {
    if (!hasUseTypes(tree.scriptItemList)) {
  ...
  transformFunctionBody(tree) {
    if (!hasUseTypes(tree.statements)) {
